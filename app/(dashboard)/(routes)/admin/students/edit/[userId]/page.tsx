...
import { getPaginatedStudentsService } from "@/services/user";
  ...
  useEffect(() => {
    if (student) {
      form.reset({
        ...
        gender: student.gender || UserGender.OTHER,
        ...
        city: student.city || "",
        state: student.state || UserState.ACTIVE,
